...
function allocateUniqueId(preferredId: string, prefix: string, usedIds: Set<string>): string {
...
function mergeVariablesForZipImport(
...
function mergeItemsForZipImport(
...
function mergeChaptersForZipImport(
...
function mergeHeroForZipImport(
...
function remapBlockForZipImport(block: StoryBlock, maps: ZipImportMergeMaps): StoryBlock {
  const remappedCore = {
...
function placeImportedNodes(existingNodes: EditorNode[], importedNodes: EditorNode[]): EditorNode[] {
